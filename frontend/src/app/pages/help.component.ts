 ...
 */
import { FaqEntry, FaqSection, HELP_SECTIONS } from '../components/help-content';
...
export class HelpComponent {
   ...
   */
  /** The whole catalogue — see components/help-content.ts. */
  private readonly sections: FaqSection[] = HELP_SECTIONS;
